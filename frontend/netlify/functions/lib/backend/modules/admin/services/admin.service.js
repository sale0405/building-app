...
export class AdminRepository {
    ...
    disableUser(userId, adminId, reason) {
    ...
    removeListing(listingId, adminId) {
        return prisma.$transaction([
...
export class AdminService {
    ...
    async disableUser(userId, adminId, reason) {
    ...
    async getAnalytics(floorId) {
        const [totalUsers, activeListings, openChores, messagesLast24h, floors] = await this.repo.getAnalytics(floorId);
